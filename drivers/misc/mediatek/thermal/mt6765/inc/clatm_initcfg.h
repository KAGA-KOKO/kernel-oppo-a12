...
#define CLATM_INIT_CFG_0_MIN_CPU_PWR	(80)
...
#define CLATM_INIT_CFG_1_MIN_CPU_PWR		(80)
#define CLATM_INIT_CFG_1_MAX_CPU_PWR		(5000)
#define CLATM_INIT_CFG_1_MIN_GPU_PWR		(80)
...
#define CLATM_INIT_CFG_2_MIN_CPU_PWR		(80)
#define CLATM_INIT_CFG_2_MAX_CPU_PWR		(5060)
#define CLATM_INIT_CFG_2_MIN_GPU_PWR		(80)
